...
celery_app = Celery(
    ...
    include=[
        ...
        "app.workers.tasks.ai_edit",
        "app.workers.tasks.captions",
...
celery_app.conf.update(
    ...
    task_routes={
        ...
        "app.workers.tasks.ai_edit.*": {"queue": "ai"},
        "app.workers.tasks.files.*": {"queue": "files"},
        "app.workers.tasks.analysis.*": {"queue": "files"},
        "app.workers.tasks.captions.*": {"queue": "files"},
        "app.workers.tasks.render.*": {"queue": "files"},
